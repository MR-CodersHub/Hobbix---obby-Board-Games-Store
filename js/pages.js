...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Render Vault Bestsellers on Home
  const homeBestsellersGrid = document.getElementById('home-bestsellers-grid');
  if (homeBestsellersGrid) {
    const bestsellers = STORE_DATA.products.filter(p => p.bestseller).slice(0, 8);
    homeBestsellersGrid.innerHTML = bestsellers.map(createProductCardHTML).join('');
  }
  ...
  const flagshipItems = [
    {
      ...
      mode: "Competitive & 6P Teams",
      features: ["Deck Building", "Worker Placement", "Spies & Intrigue"],
      special: "Summon sandworms and wage cutthroat galactic warfare for Arrakis.",
      bggRank: "#6 Worldwide",
    ...
    },
    {
      ...
      mode: "Co-op Campaign & Solo",
      features: ["Tactical Combat", "Outpost Crafting", "Branching Story"],
      special: "Over 100 deep tactical scenarios with persistent town progression.",
      bggRank: "#3 Thematic",
    ...
    },
    {
      ...
      mode: "Competitive Economic Euro",
      features: ["Canal & Rail Networks", "Coal & Iron Market", "Zero-Luck Depth"],
      special: "The #1 ranked board game of all time with unrivaled economic strategy.",
    ...
    },
    {
      ...
      mode: "Competitive & Automa Solo",
      features: ["Engine Building", "Card Combos", "Habitat Drafting"],
      special: "170+ illustrated bird species with tactile custom food dice.",
    ...
    setTimeout(() => {
      display.innerHTML = `
        <div class="flagship-card-inner">
          <div class="flagship-img-wrap" onclick="openQuickView('${item.id}')" style="cursor: pointer;" title="Click for Quick Preview">
            <img src="${item.image}" alt="${item.title}" class="flagship-img">
            <div class="flagship-gradient-overlay"></div>
            <span class="flagship-badge"><i class="fa-solid fa-crown text-gold"></i> ${item.badge}</span>
          ...
          <div class="flagship-info">
            <div class="flagship-header-row">
              <h3 class="flagship-title" onclick="openQuickView('${item.id}')" style="cursor: pointer;">${item.title}</h3>
            ...
            <div style="display:flex; gap:0.4rem; flex-wrap:wrap; margin-bottom:0.45rem;">
              <span class="badge badge-gold"><i class="fa-solid fa-gamepad text-gold"></i> ${item.mode}</span>
            </div>
            
            <div class="card-features-chips">
              ${item.features.map(f => `<span class="card-feature-badge"><i class="fa-solid fa-check text-gold"></i> ${f}</span>`).join('')}
            </div>

            <div class="card-special-snippet" title="${item.special}">
        ...
        <div class="hof-grand-champion" onclick="openQuickView('${champ.id}')">
          ...
          <div class="hof-champ-body">
            <div style="display:flex; gap:0.5rem; align-items:center; margin-bottom:0.4rem; flex-wrap:wrap;">
              <h3 class="hof-champ-title" style="margin-bottom:0;">${champ.title}</h3>
              <span class="card-mode-pill"><i class="fa-solid fa-gamepad text-gold"></i> ${champ.mode || 'Co-op & Competitive'}</span>
            </div>
            
            <div class="card-features-chips" style="margin: 0.4rem 0;">
              ${(champ.features || []).map(f => `<span class="card-feature-badge"><i class="fa-solid fa-check text-gold"></i> ${f}</span>`).join('')}
            </div>

            <div class="card-special-snippet" style="margin-bottom:0.85rem;" title="${champ.special || champ.description}">
              <i class="fa-solid fa-gem text-gold"></i>
              <span>${champ.special || champ.description}</span>
            </div>
            ...
            <div class="hof-champ-footer">
              ...
              <div class="hof-champ-actions">
                ...
                <button class="btn btn-secondary" onclick="event.stopPropagation(); openQuickView('${champ.id}')">
                  <i class="fa-solid fa-eye"></i> Quick View
                </button>
              </div>
            </div>
              ...
              <div class="hof-roster-card ${medal.class}" onclick="openQuickView('${prod.id}')">
                ...
                <div class="hof-roster-info">
                  ...
                  <div style="margin: 0.25rem 0;">
                    <span class="card-mode-pill"><i class="fa-solid fa-gamepad text-gold"></i> ${prod.mode || 'Co-op & Competitive'}</span>
                  </div>
        ...
        <div class="showdown-card">
          ...
          <div class="showdown-metrics-list">
            <div class="metric-row">
              ...
              <div class="metric-bar"><div class="metric-fill gold" style="width: ${item.gameA.strategyDepth}%;"></div></div>
            </div>
            <div class="metric-row">
            ...
            <div class="metric-row">
              ...
              <div class="metric-bar"><div class="metric-fill gold" style="width: ${item.gameA.replayability}%;"></div></div>
            </div>
            <div class="metric-row">
              <div class="metric-label"><span>Table Presence</span><strong>${item.gameA.tablePresence}%</strong></div>
              <div class="metric-bar"><div class="metric-fill gold" style="width: ${item.gameA.tablePresence}%;"></div></div>
            </div>
          </div>
        ...
        <div class="showdown-card">
          ...
          <div class="showdown-metrics-list">
            <div class="metric-row">
              ...
              <div class="metric-bar"><div class="metric-fill gold" style="width: ${item.gameB.strategyDepth}%;"></div></div>
            </div>
            <div class="metric-row">
            ...
            <div class="metric-row">
              ...
              <div class="metric-bar"><div class="metric-fill gold" style="width: ${item.gameB.replayability}%;"></div></div>
            </div>
            <div class="metric-row">
              <div class="metric-label"><span>Table Presence</span><strong>${item.gameB.tablePresence}%</strong></div>
              <div class="metric-bar"><div class="metric-fill gold" style="width: ${item.gameB.tablePresence}%;"></div></div>
            </div>
          </div>
          <div class="showdown-ideal-box">
            <i class="fa-solid fa-bullseye text-gold"></i>
